...
impl Connection {
    ...
    pub(crate) async fn send_message(
        ...
        let write_result: Result<()> = match self.compressor {
        ...
        let write_result: Result<()> = message.write_op_msg_to(&mut self.stream).await;
        ...
        let response_message_result: Result<Message> = Message::read_from(
            &mut self.stream,
